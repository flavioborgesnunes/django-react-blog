                            ...
                            <div className="card-body p-6">
                                ...
                                <form className="needs-validation" onSubmit={handleRegister}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" onChange={handleBioDataChange} value={bioData.full_name} id="full_name" className="form-control" name="full_name" placeholder="Name" required="" />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="email" className="form-label">
                                            Email Address
                                        </label>
                                        <input type="email" onChange={handleBioDataChange} value={bioData.email} id="email" className="form-control" name="email" placeholder="E-mail" required="" />
                                    </div>
